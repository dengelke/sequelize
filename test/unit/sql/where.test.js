      ...
      suite('JSON', () => {
        test('sequelize.json("profile.id"), sequelize.cast(2, \'text\')")', function() {
          expectsql(sql.whereItemQuery(undefined, this.sequelize.json('profile.id', this.sequelize.cast('12346-78912', 'text'))), {
            mysql: "json_extract(`profile`, '$.id') = CAST('12346-78912' AS TEXT)",
        ...
        testsql('data', {
          ...
          mysql: "json_extract(`User`.`data`, '$.nested.attribute') = 'value'",
        ...
        testsql('data', {
          ...
          mysql: "json_extract(`data`, '$.nested') IN (1, 2)",
        ...
        testsql('data', {
          ...
          mysql: "json_extract(`data`, '$.nested') BETWEEN 1 AND 2",
        ...
        testsql('data', {
          ...
          mysql: "(json_extract(`User`.`data`, '$.nested.attribute') = 'value' AND json_extract(`User`.`data`, '$.nested.prop') != 'None')",
        ...
        testsql('data', {
          ...
          mysql: "(json_extract(`User`.`data`, '$.name.last') = 'Simpson' AND json_extract(`User`.`data`, '$.employment') != 'None')",          
        ...
        testsql('data', {
          ...
          mysql: "(json_extract(`data`, '$.price') = 5 AND json_extract(`data`, '$.name') = 'Product')",
        ...
        testsql('data.nested.attribute', 'value', {
          ...
          mysql: "json_extract(`data`, '$.nested.attribute') = 'value'",
        ...
        testsql('data.nested.attribute', 4, {
          ...
          mysql: "json_extract(`data`, '$.nested.attribute') = 4",          
        ...
        testsql('data.nested.attribute', {
          ...
          mysql: "json_extract(`data`, '$.nested.attribute') IN (3, 7)",
        ...
        testsql('data', {
          ...
          mysql: "json_extract(`data`, '$.nested.attribute') > 2",
        ...
        testsql('data', {
          ...
          mysql: "CAST(json_extract(`data`, '$.nested.attribute') AS INTEGER) > 2",
        ...
        testsql('data', {
          ...
          mysql: "json_extract(`data`, '$.nested.attribute') = true",
        ...
        testsql('metaData.nested.attribute', 'value', {
          ...
          mysql: "json_extract(`meta_data`, '$.nested.attribute') = 'value'",
